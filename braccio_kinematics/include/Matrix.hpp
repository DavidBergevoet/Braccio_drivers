...
public:
   ...
   *
   */
  static_assert(std::is_arithmetic<T>::value, "Value T must be arithmetic, see "
  ...
  /**
   * Ctor with a list of lists of values where aList must contain M elements and each list in aList must contain N
   * elements
   */
